...
// Validar el correo antes de consultar la base de datos.
...
// Limitar los intentos para evitar abusos del formulario de recuperación.
...
if ($usuario) {
    // Guardar únicamente el hash del token; el valor original se envía por correo.
    ...
    // Construir el enlace usando la URL configurada en la aplicación.
...
// Mantener una respuesta genérica para no revelar si la cuenta existe.
